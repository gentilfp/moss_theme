...
**Specification phase.** This repository contains only the theme specification:
...
Editor and terminal ports **do not exist yet**. Neovim, Zed, Ghostty, VS Code, Orca,
and other integrations will be added later, in separate repositories, from `SPEC.md`.
